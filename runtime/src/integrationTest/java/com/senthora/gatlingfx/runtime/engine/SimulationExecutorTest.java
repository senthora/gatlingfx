...
import com.senthora.gatlingfx.runtime.engine.support.MockSimulationRunResult;
import com.senthora.gatlingfx.runtime.engine.support.MockSimulationRunner;
...
class SimulationExecutorTest {
    ...
    void should_ReportSuccessfulSimulations_when_SimulationSucceeds() {
        SimulationExecutor.setRunner(() -> MockSimulationRunner.with(
                MockSimulationRunResult.ALWAYS_SUCCESS
        ));
    ...
    void should_ReportFailedSimulations_when_SimulationFails() {
        SimulationExecutor.setRunner(() -> MockSimulationRunner.with(
                MockSimulationRunResult.ALWAYS_FAIL
        ));
        var results = GatlingFxEngineKit.engine()
